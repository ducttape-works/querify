...
export const dbEngines: SupportEngine[] = [
  {
    name: SupportedEngine.POSTGRESQL,
  ...
  {
    name: SupportedEngine.CASSANDRA,
  ...
  {
    name: SupportedEngine.CLICKHOUSE,
